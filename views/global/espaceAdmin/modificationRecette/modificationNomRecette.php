        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <br>
              <form action="controllerAdmin/modifierRecetteParSonNom/<?=$conservation?>" method="post" >

                <div class="form-outline mb-4">
                  <input type="text" id="nomRecette"name="nomRecette" class="form-control form-control-lg">
                  <label class="form-label" for="nomRecette">Nouveau nom de la recette</label>
                </div>
                ...
                <div class="d-flex justify-content-center">
                  <button type="submit"name="mettreAJourNomRecette"
