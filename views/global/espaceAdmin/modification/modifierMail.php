        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Modifier Mail de l'utilisateur</h2>

            
              <br>
              <form action="controllerAdmin/modifierUtilisateurParSonMail/<?=$conservation?>" method="post" >

                <div class="form-outline mb-4">
                  <input type="email" id="mail"name="mail" class="form-control form-control-lg" value=<?php if(isset($_COOKIE['email'])){echo $_COOKIE['email'];}?>>
                  <label class="form-label" for="mail">Nouveau email de l'utilisateur</label>
                </div>
                ...
                <div class="d-flex justify-content-center">
                  <button type="submit"name="mettreAJourMail"
