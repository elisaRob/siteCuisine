...
?>
 ...
 <h2 class='text-danger text-center' id='HEntree'>Mes favoris</h2>
...
foreach($resultatRecupererIdRecetteMonPanier->fetchAll(PDO::FETCH_NUM) as $valeur)
{
    //echo $valeur[0];
    //echo '<br>';
  
    //echo $valeur[1];
    $resultatRecupererRecetteDeMonPanier=modelRecupererLesRecettesDeMonPanier($valeur[0]);
    $resultatV=$resultatRecupererRecetteDeMonPanier->fetchAll(PDO::FETCH_ASSOC);
